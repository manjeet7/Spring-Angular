    ...
    _.extend(AvastWRC,
        {
            ...
            init: function () {
                ...
                if(AvastWRC.Utils.getBrowserInfo().isFirefox()){
                    if (this.showOptInMessage(newInstall)) {
                        let tabId = null;
            ...
            showOptInMessage: function (newInstall) {                
                if(newInstall || 
                    (!AvastWRC.CONFIG.OPT_IN.functional && chrome.runtime.getManifest().version !== AvastWRC.CONFIG.OPT_IN.show4Version)){
                    return true;
                }
                return false;
            },
